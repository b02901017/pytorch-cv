...
from src.attention.SelfAttention import ScaledDotProductAttention
from src.attention.SimplifiedSelfAttention import SimplifiedScaledDotProductAttention
